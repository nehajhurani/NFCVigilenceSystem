...
public class WriteA extends AppCompatActivity {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(myTag ==null) {
                    ...
                    mydb = new Databaseop(WriteA.this);
                    ...
                    for (int j = 0; j <= array.length - 1; j++) {
                        if (e1.getText().toString().equals(array[j])) {
                            Toast.makeText(WriteA.this, "Compartment Name already exists", Toast.LENGTH_SHORT).show();
                            flag = 1;
                            break;
                        } else if (e1.getText().toString().equals("")) {
                            Toast.makeText(WriteA.this, "Enter Compartment Name", Toast.LENGTH_SHORT).show();
                            flag = 1;
                            break;
                        } else {
                            flag = 0;
                    ...
                    if (flag == 0) {
                        new AlertDialog.Builder(WriteA.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Warning")
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        if (tag == null) {
            ...
            if (parcelables != null && parcelables.length > 0) {
                ...
                Toast.makeText(WriteA.this, "no ndef message", Toast.LENGTH_SHORT).show();
            }
...
//            textViewInfo.setText(tagcontent);
    ...
    public void onBackPressed() {
        Intent i = new Intent(WriteA.this, Main8Activity.class);
        startActivity(i);
    }

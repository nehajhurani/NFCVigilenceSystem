...
public class WriteM extends AppCompatActivity {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(myTag ==null) {
                    ...
                    mydb = new Databaseop(WriteM.this);
                    ...
                    for (int j = 0; j <= array.length - 1; j++) {
                        if (e1.getText().toString().equals(array[j])) {
                            Toast.makeText(WriteM.this, "Route Name already exists", Toast.LENGTH_SHORT).show();
                            flag = 1;
                            break;
                        } else if (e1.getText().toString().equals("")) {
                            Toast.makeText(WriteM.this, "Enter Compartment Name", Toast.LENGTH_SHORT).show();
                            flag = 1;
                            break;
                        } else {
                            flag = 0;
                    ...
                    if (flag == 0) {
                        new AlertDialog.Builder(WriteM.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Warning")
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        if (tag == null) {
            ...
            if (parcelables != null && parcelables.length > 0) {
                ...
                Toast.makeText(WriteM.this, "no ndef message", Toast.LENGTH_SHORT).show();
            }
...
//            textViewInfo.setText(tagcontent);
    ...
    public void onBackPressed() {
        Intent i = new Intent(WriteM.this, Main5Activity.class);
        startActivity(i);
    }
